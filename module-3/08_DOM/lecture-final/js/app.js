...
const description = 'Host and plan the perfect <strong>cigar party</strong> for all of your squirrelly friends.';
const reviews = [
  {
  ...
  },
  {
    ...
    review:
      "It should have been called the <q>four hour cigar party</q>. That's amazing. I have a new idea for muse because of this.",
    rating: 4
  },
  {
...
function displayReviews() {
  ...
  reviews.forEach((review) => {
    ...
    let reviewDiv = document.createElement('div'); // creates a <div> but doesn't add it to the page yet
    //reviewDiv.innerText = 'I am a review';
    //reviewDiv.id = review.reviewer;

    // ... add the review class to that div
    reviewDiv.classList.add('review'); // adds "review" to the element's list of CSS classes
    reviewDiv.classList.remove('trogdor'); // If this class was present, it gets removed.
    ...
    // ... addReview
    addReview(reviewDiv, review.review); // the review attribute on each review (the content of the review)

    // ... add the div to the application area
    main.appendChild(reviewDiv); // this makes the reviewDiv part of the DOM and displays it on the page
  ...
  // NOTE: querySelectorAll will always return an array-like object
...
function addReview(parent, review) {
  ...
  para.innerHTML = review; // For legal reasons, this is a very bad idea, but we now support HTML content
