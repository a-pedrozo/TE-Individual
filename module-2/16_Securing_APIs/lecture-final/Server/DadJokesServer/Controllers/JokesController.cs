...
namespace DadJokesServer.Controllers
{
    [Route("jokes")]
    [ApiController]
    [Authorize] // Every endpoint requires authorization BY DEFAULT
    public class JokesController : ControllerBase
    {
        ...
        [HttpDelete("{id}")]
        [Authorize(Roles = "Admin, Moderator")] // Only authenticated users (passing a valid JWT) can call this
        ...
        [HttpGet] // GET Jokes
        [AllowAnonymous] // Unauthenticated users can call this method
        ...
        public ActionResult CreateJoke(Joke joke)
        {
            ...
            // This ID came from the JWT's "sub" claim. sub == subject or the ID of the user.
            joke.UserId = id;
        ...
        public ActionResult UpdateJoke(int jokeId, [FromBody] Joke joke)
        {
            ...
            {
                return Forbid("You are not the creator of this joke"); // 403 Forbidden status code
            }
