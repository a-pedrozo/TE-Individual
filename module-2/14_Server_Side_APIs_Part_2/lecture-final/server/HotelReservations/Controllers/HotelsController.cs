...
namespace HotelReservations.Controllers
{
    ...
    public class HotelsController : ControllerBase
    {
        ...
        public ActionResult ListHotels()
        {
            ...
            return Ok(hotels); // 200 OK status code with a body of hotels serialized to JSON
        }
        ...
        public ActionResult GetHotel(int id)
        {
            if (id <= 0)
            {
                return BadRequest("hotelId must be positive but was " + id);
            }
            ...
            if (hotel == null)
            {
                return NotFound("Could not find hotel " + id); // 404 with a message
            }
            ...
            {
                int divisor = 0;
                int answer = 42 / divisor; // This will error!
            }
        ...
        public ActionResult ListReservationsByHotel(int hotelId)
        {
            ...
            if (hotelId <= 0)
            {
                return BadRequest("hotelId must be positive but was " + hotelId);
            }
