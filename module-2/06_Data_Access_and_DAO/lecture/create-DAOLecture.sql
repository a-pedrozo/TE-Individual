...
DROP DATABASE IF EXISTS DAOArtGallery;
GO

-- Create a new ArtGallery Database
CREATE DATABASE DAOArtGallery;
GO
...
INSERT INTO Person (address, person_name)
VALUES 
	('42 Wallaby Way', 'Jimothy'), 
	('1600 Pennsylvania Avenue', 'Presidential Mainframe'),
	('1 Bruce Wayne Parkway', 'The Batman')


INSERT INTO Painting (artist_id, painting_title)
VALUES 
	(1, 'Man with Cheese'), 
	(3, 'Dog barking at Rabbit'), 
	(2, 'Matt Reading Book'), 
	(3, 'John Standing Up')
