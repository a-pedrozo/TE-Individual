    ...
    public class LectureCode
    {
        ...
        private void DictionaryCoinFlipExample()
        {
            ...
            {   // have we seen this coin value before?
                ...
                {    // we've seen it before, increase its count by 1 .conainskey is the key
        ...
        private void UsernamePasswordExample() // like animal problem , pick one case either upper or lower 
        {
            Dictionary<string, string> passwords = new Dictionary<string, string>();
            passwords["MEland"] = "FuzzyBunny";
            passwords["Dan"] = "Fingerguns";
            ...
            {
                string actualPassword = password[username];
