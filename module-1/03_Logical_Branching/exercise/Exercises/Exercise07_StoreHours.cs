...
namespace TechElevator.Exercises.LogicalBranching
{
    ...
    public class StoreHours
    {
        ...
        /*
         * Shelia's Seashell Store is open between 8 am (hour 8) and 5 pm (hour 17) on Monday (day M), Wednesday (day W), 
         * and Friday (day F).
         * 
         * In the summer, the store is open until 8 pm(hour 20) on Wednesday(day W) and is also open Saturday(day S) from 
         * 9 am(hour 9) to 3 pm(hour 15).
         * 
