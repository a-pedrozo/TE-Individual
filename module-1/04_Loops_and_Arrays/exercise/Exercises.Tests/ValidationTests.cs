...
namespace Exercises.Tests
{
    ...
    public class ValidationTests
    {
        ...
        [TestMethod]
        public void Exercise04_FirstCard()
        {
        ...
        public void Exercise04_DiscardTopCard()
        {
            ...
            CollectionAssert.AreEqual(new string[] { "7-H", "5-H", "8-H", "6-H" },
                exercises04.DiscardTopCard(new string[] { "3-H", "7-H", "5-H", "8-H", "6-H" }),
                                          "DiscardTopCard(\"3-H\", \"7-H\", \"5-H\", \"8-H\", \"6-H\")");

            CollectionAssert.AreEqual(new string[] { "1-D", "1-H", "1-S", "2-C" },
                exercises04.DiscardTopCard(new string[] { "1-C", "1-D", "1-H", "1-S", "2-C" }),
                                         "DiscardTopCard(\"1-C\", \"1-D\", \"1-H\", \"1-S\", \"2-C\")");

            CollectionAssert.AreEqual(new string[] { "Q-D", "J-H", "10-S", "Q-C" },
                exercises04.DiscardTopCard(new string[] { "K-C", "Q-D", "J-H", "10-S", "Q-C" }),
                                          "DiscardTopCard(\"K-C\", \"Q-D\", \"J-H\", \"10-S\", \"Q-C\")");
        }


        [TestMethod]

        public void Exercise05_BellowFreezing()
        {
